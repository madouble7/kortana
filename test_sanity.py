...
def test_kortana_basic_conversation():
    ...
    try:
        ...
        print(f"User: Hello Kor'tana, are you working?")
        ...
        try:
            response4 = engine.get_response("Can you search your memory for our previous conversations?", enable_function_calling=True)
