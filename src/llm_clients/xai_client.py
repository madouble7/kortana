...
class XAIClient(BaseLLMClient):
    ...
    def __init__(self, api_key: Optional[str] = None, model_name: str = "grok-3-mini", **kwargs):
        """
        ...
        try:
            ...
            logger.error("OpenAI library required for XAI client. Install with: pip install openai")
            self.client = None
    ...
    def _standardize_response(self, content: str, model_id: str, usage: Dict[str, int], function_call: Optional[Dict] = None, finish_reason: str = "stop") -> Dict[str, Any]:
        ...
        logger.debug(f"_standardize_response received: content='{content[:50]}...', model_id={model_id}, usage={usage}, function_call={function_call}, finish_reason={finish_reason}")
    ...
    def generate_response(self, system_prompt: str, messages: List[Dict[str, str]], 
        ...
        if not self.available or not self.client:
            ...
            return self._standardize_response(content="XAI client not available.", model_id=self.model_name, usage={}, finish_reason="error")
        ...
        try:
            ...
            completion_args = {
                ...
                "temperature": kwargs.get("temperature", 0.5),  # Lower temp for reasoning
            ...
            if enable_function_calling and functions:
                 ...
                 completion_args["tool_choice"] = kwargs.get("tool_choice", "auto") # Use 'tool_choice' not 'function_call'
    ...
    def get_capabilities(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "optimal_for": ["autonomous_development", "code_generation", "reasoning", "self_improvement"]
        }
