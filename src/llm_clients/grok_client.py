...
class GrokClient(BaseLLMClient):
    ...
    def generate_response(self, system_prompt: str, messages: List) -> Dict[str, Any]:
        ...
        extra_body_params = {"reasoning_effort": reasoning_effort_to_use}
        api_params["extra_body"] = (
            extra_body_params  # For OpenAI compatible clients that support extra_body
        )
        ...
        try:
            ...
            if not reasoning_raw and hasattr(
                ...
                in completion._dict.get("choices", [{}])[0].get("message", {})
            ):
                reasoning_raw = completion._dict["choices"][0]["message"][
                    "reasoning_content"
                ]
    ...
    def estimate_cost(self, prompt_tokens: int, completion_tokens: int) -> float:
        ...
        logging.warning("Grok cost estimation is a placeholder.")
    ...
    def test_connection(self) -> bool:
        ...
        try:
            # Attempt a minimal chat completion call
