...
from .goal_framework import Goal, GoalType, GoalStatus
...
class GoalManager:
    ...
    def create_goal_from_template(self, goal_type: GoalType, template_name: str, **overrides) -> Optional[Goal]:
    ...
    def _load_goal_from_memory(self, goal_id: str) -> Optional[Goal]:
