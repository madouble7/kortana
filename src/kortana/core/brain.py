...
import os
import sys
from src.utils.text_analysis import analyze_sentiment, detect_keywords, detect_emphasis_all_caps
    ...
    try:
        ...
        while True:
            ...
            try:
                ...
                print(f"Kortana: i encountered an error while processing your request.")
        ...
        logging.error(
            f"ChatEngine encountered an unhandled exception in main loop: {e}", exc_info=True
        )
