...
class TILNote(Base):
    """Today I Learned (TIL) note model for storing quick knowledge snippets."""

    __tablename__ = "til_notes"
    __table_args__ = {"extend_existing": True}
    ...
    source = Column(String(100), default="manual")  # manual, conversation, insight
    created_at = Column(DateTime(timezone=True), server_default=func.now())
    updated_at = Column(
