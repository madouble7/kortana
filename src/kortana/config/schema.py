...
class KortanaConfig(BaseModel):
    ...
    def validate_log_level(cls, v) -> str:
        ...
        Returns:
            The normalized log level in uppercase
    ...
    def validate_environment(cls, v) -> str:
        ...
        Returns:
            The normalized environment name in lowercase

        Raises:
            ValueError: If the environment name is not a valid one
        """
...
def load_config_from_env() -> KortanaConfig:
    ...
    # Override with environment variables (None-safe)
