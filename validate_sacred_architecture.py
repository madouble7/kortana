...
def test_router_initialization():
    ...
    try:
        ...
        if models_count < 10:
            print(f"⚠️  Expected 10+ models from Revolutionary Expansion, got {models_count}")
            print("   Check that all new models are properly configured")
        else:
            print(f"🎉 Revolutionary Expansion confirmed: {models_count} models loaded!")
        ...
        for provider, models in models_by_provider.items():
            ...
            for model in models:
                enabled = router.loaded_models_config.get('models', {}).get(model, {}).get('enabled', True)
...
def test_strategic_guidance(router):
    ...
    try:
        ...
        for category in test_categories:
            ...
            print(f"   Prioritized Principles: {guidance.get('prioritize_principles', [])}")
        ...
        creative_principles = guidance_results.get('creative_writing', {}).get('prioritize_principles', [])
        code_principles = guidance_results.get('code_generation', {}).get('prioritize_principles', [])
    ...
    try:
        ...
        test_scenarios = [
            ...
            },
            {
                ...
                "likely_models": ["grok-3-mini-reasoning", "deepseek-chat-v3-openrouter"]
            },
            {
            ...
            },
            {
                ...
                "likely_models": ["llama-4-maverick-openrouter", "grok-3-mini-reasoning"]
            },
            {
        ...
        for scenario in test_scenarios:
            ...
            if selected_model:
                ...
                if selected_model in scenario['likely_models']:
                    print(f"   🌟 PERFECT: Selected model is in expected list!")
                else:
                ...
                if model_config:
                    ...
                    print(f"   💰 Provider: {provider}, Cost: ${cost_input}/${cost_output} per 1M tokens")
            else:
        ...
        print(f"📊 SELECTION DIVERSITY ANALYSIS:")
        ...
        if diversity_ratio > 0.6:
            print(f"✅ Excellent model selection diversity!")
        elif diversity_ratio > 0.4:
            print(f"✅ Good model selection diversity")
        else:
            print(f"⚠️  Low selection diversity - may need routing optimization")
    ...
    try:
        ...
        for model_id in test_models:
            ...
            if sacred_scores:
                ...
                print(f"   ❌ No sacred alignment scores found")
                missing_scores.append(model_id)
            print()
        
        # EXPANDED VALIDATION: Check expected alignments
        validation_checks = [
            ("claude-3.7-sonnet", "compassion", 0.8, "Claude should excel in compassion"),
            ("grok-3-mini-reasoning", "wisdom", 0.8, "Grok should excel in wisdom/reasoning"),
            ("qwen3-235b-openrouter", "wisdom", 0.8, "Qwen should excel in knowledge/wisdom"),
            ("noromaid-20b-openrouter", "compassion", 0.7, "Noromaid should be empathetic"),
            ("deepseek-chat-v3-openrouter", "truth", 0.7, "DeepSeek should be precise/truthful")
        ]
        ...
        if hasattr(router, 'routing_history') and router.routing_history:
            ...
            if history_count > 0:
                ...
                for i, decision in enumerate(recent_decisions, 1):
                    ...
                    print(f"      Selected: {decision.get('selected_model', 'unknown')}")
                ...
                model_selections = [d.get('selected_model') for d in router.routing_history if d.get('selected_model')]
                ...
                task_selections = [d.get('task_category') for d in router.routing_history if d.get('task_category')]
            ...
            print("📝 No routing history available yet (expected for fresh initialization)")
...
def test_brain_integration():
    ...
    try:
        ...
        if hasattr(engine, 'sacred_router'):
            ...
            router_models = len(engine.sacred_router.loaded_models_config.get('models', {}))
        ...
        try:
            ...
            print(f"   📊 {available_count}/{total_required} autonomous models available")
...
def run_full_validation():
    ...
    print("   Verifying Gemini 2.5 Flash, Grok 3 Mini, Claude Sonnet, and 7+ new models...")
    print()
    ...
    if not router:
        print("❌ CRITICAL FAILURE: Revolutionary expansion router failed. Cannot proceed.")
        return False
    ...
    if success_rate == 100:
        ...
        print("   • Multi-provider optimization (OpenAI, Google, XAI, Anthropic, OpenRouter)")
        ...
        print("   • Test expanded consciousness: python test_autonomous_consciousness.py")
