"""
Quick Run Script for Kor'tana

Performs minimal setup and runs the core system for testing.
"""
...
def main():
    """Run setup steps and then launch the brain module."""
...
""",
    ...
    result = subprocess.run([sys.executable, "-m", "src.kortana.core.brain"])
