...
def create_genesis_goal():
    ...
    try:
        ...
        existing_goal = (
            db.query(Goal).filter(Goal.description.like("%GENESIS%")).first()
        )
        if existing_goal:
        ...
        # Create the Genesis Protocol goal description
...
- CREATE_FILE: To create new service modules"""
        ...
        print()
        print(
            "🤖 The autonomous system will begin processing this goal in the next cycle..."
        )
