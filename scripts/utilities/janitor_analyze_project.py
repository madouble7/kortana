...
Analyze Kor'tana project structure for cleanup planning
"""

from pathlib import Path


def count_pattern_files(directory, pattern):
...
def analyze_directory():
    ...
    print("")
    print("# Move test scripts")
    print("mv test_*.py scripts/")
    print("")
    print("# Move check scripts")
    print("mv check_*.py scripts/")
    print("")
    print("# Move log files")
    print("mv *.log archive/logs/")

    # Print potential subdivision structure
    print("\n📂 RECOMMENDED SUBDIRECTORY STRUCTURE")
    print("-" * 50)
    print("scripts/")
    print("├── tests/         # All test_*.py files")
    print("├── checks/        # All check_*.py files")
    print("├── monitoring/    # All monitor_*.py files")
    print("├── launchers/     # All launch_*.py files")
    print("└── utilities/     # Other utility scripts")
    print("")
    print("archive/")
    print("├── logs/          # Old log files")
    print("├── reports/       # Old report files (txt/md)")
    print("├── batches/       # Old batch-specific files")
    print("└── obsolete/      # Truly obsolete code")
