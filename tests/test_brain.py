...
def test_set_mode(chat_engine_instance: ChatEngine):
    ...
    if "default" in chat_engine_instance.persona_config.get("modes", {}):
        ...
        assert chat_engine_instance.current_mode == "default"
         ...
         chat_engine_instance.set_mode(chat_engine_instance.persona_config.get("default_mode", "default"))
         assert chat_engine_instance.current_mode == chat_engine_instance.persona_config.get("default_mode", "default")
...
def test_get_response_basic(chat_engine_instance: ChatEngine):
    ...
    default_mode_name = chat_engine_instance.persona_config.get("persona", {}).get("default_mode") or \
