...
class TestMemoryHelpers:
    ...
    def test_load_memory(self, mock_memory_file):
        ...
        assert (
            memories[0]["content"] == "Test decision"
        ), "Wrong content for first memory"
        assert (
            memories[1]["type"] == "implementation_note"
    ...
    def test_save_memory(self):
        ...
        with patch("builtins.open", m):
            with patch("os.makedirs"):
                ...
                assert (
                    json.dumps(memory) in written_content
    ...
    def test_save_decision(self):
        ...
        with patch("core.memory.save_memory") as mock_save:
            ...
            assert (
                call_args["content"] == "Test decision"
    ...
    def test_save_project_insight(self):
        ...
        with patch("core.memory.save_memory") as mock_save:
            ...
            assert (
                call_args["content"] == "Test insight"
            ), "Wrong content in saved memory"
    ...
    def test_get_memory_by_type(self, mock_memory_file):
        ...
        assert (
            decision_memories[0]["content"] == "Test decision"
        ...
        assert (
            note_memories[0]["content"] == "Test note"
    ...
    def test_get_recent_memories_by_type(self, mock_memory_file):
        ...
        assert (
            recent_decisions[0]["content"] == "Test decision"
