...
def _detect_prosody(text: str) -> tuple[str, str]:
    ...
    warmth = {"love", "glad", "happy", "wonderful", "beautiful", "proud",
              "grateful", "blessed", "joy", "peace", "grace", "faith"}
    concern = {"sorry", "unfortunately", "careful", "warning", "worried",
               "difficult", "struggle", "hard", "pain", "hurt"}
