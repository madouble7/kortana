...
#
# Wisdom, predictions, and self-model snapshots are SELF-GENERATED
# by the Silent Reviewer daemon loop via the Autonomy Orchestrator.
# All public endpoints below are READ-ONLY observations.
# ==================================================================
...
async def get_autonomy_status() -> Dict[str, Any]:
    """Read-only: last autonomy orchestrator cycle result."""
    from src.kortana.services.autonomy_orchestrator import get_last_cycle_result
