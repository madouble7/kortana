...
def create_user(user: UserCreate) -> UserInDB:
    ...
    Args:
        user: UserCreate with registration data
...
async def logout(
    ...
    # await redis_client.sadd("blacklisted_tokens", current_token)
...
async def deactivate_account(
    ...
    Sets user as inactive. Can be reactivated by admin.
    """
    user = get_user_by_email(current_user.email)
