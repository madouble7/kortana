...
class TestOrchestrator:
    ...
    def generate_test_report(self, task_id: str | None = None) -> str:
...
| Duration | {results["tests"].duration_ms}ms |
...
@router.post("/report")
async def generate_test_report(task_id: str | None = None) -> dict[str, Any]:
    """Generate markdown test report"""
    try:
        report = test_orchestrator.generate_test_report(task_id)
